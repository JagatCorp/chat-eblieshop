...
function groupChatAddingModalInit() {
  ...
  */
    ...
    // add member grup dari hasil search yang di select
    // $("body").on(
    //     "click",
    ...
    // // Ketika item pengguna dipilih, tambahkan atribut data-user ke item tersebut
    // $("body").on(
    //     "click",
    //     ".search-records.add-member .user-list-item",
    //     function () {
    ...
    //         addedUserView.prepend($(this).attr("data-user", userID)); // Menambahkan atribut data-user ke item yang dipilih
    //         addedUserIds.push(Number(userID));
    //     }
    // );
